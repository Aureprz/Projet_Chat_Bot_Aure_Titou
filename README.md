...
* aprés le lancement vous avez le choix parmi 9 options :
    ...
    - ``1``
        Vous permet de choisir entre les differents méthodes de calculs du ou des terme(s) sélectionnés [(info tf_idf)](https://en.m.wikipedia.org/wiki/Tf%E2%80%93idf)
